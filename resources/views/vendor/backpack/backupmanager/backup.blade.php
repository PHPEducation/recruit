        ...
        <div class="box-body">
            <button id="create-new-backup-button"
                ...
                <span class="ladda-label">
                    ...
                    {{ trans('backpack::backup.create_a_new_backup') }}
                </span>
            </button>
            <br>
                        ...
                        <td class="text-right">
                            @if ($backup['download'])
                                <a class="btn btn-xs btn-default"
                                   href="{{ url(config('backpack.base.route_prefix', 'admin') . '/backup/download/') }}?disk={{ $backup['disk'] }}&path={{ urlencode($backup['file_path']) }}&file_name={{ urlencode($b['file_name']) }}"><i
                                            class="fa fa-cloud-download"></i>
                                    {{ trans('backpack::backup.download') }}
                                </a>
                            @endif
                            <a class="btn btn-xs btn-danger" data-button-type="delete"
                               href="{{ url(config('backpack.base.route_prefix', 'admin') . '/backup/delete/' . $backup['file_name']) }}?disk={{ $backup['disk'] }}"><i
                                        class="fa fa-trash-o"></i>
                                {{ trans('backpack::backup.delete') }}
                            </a>
                        </td>
                    </tr>
                @endforeach
