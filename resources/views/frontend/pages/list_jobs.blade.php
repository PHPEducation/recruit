...
<head>
    ...
    <link rel="icon" href="https://yt3.ggpht.com/a-/AJLlDp33Jtm-wmda_ZVnmhT962ZCgPj9NED9enIUgQ=s900-mo-c-c0xffffffff-rj-k-no" type="image/x-icon">
    <title>Lựa chọn những mẫu CV phù hợp nhất với bạn</title>
    <meta name="description" content="Nộp CV và ứng tuyển ngay vào những vị trí vô cùng hấp dẫn tại S4C Club. Cùng nhau trải nghiệm môi trường làm việc nhóm năng động, hiện đại và đầy nhiệt huyết.">

    <link rel="stylesheet" href="https://www.topcv.vn/v2/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://www.topcv.vn/v2/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://www.topcv.vn/v3/css/welcome.css?v=1.0.7">
    ...
    <link rel="stylesheet" href="https://www.topcv.vn/v3/css/style.css?v=1.1.0">
    <link rel="stylesheet" href="https://www.topcv.vn/v2/plugins/switchery/switchery.min.css">
    <link rel="stylesheet" href="https://www.topcv.vn/css/sign-in-popup.css?v=2.0.3">
    <link rel="stylesheet" href="https://www.topcv.vn/v3/css/support-ticket.css?v=1.0.2">
    <link rel="stylesheet" href="https://www.topcv.vn/v3/css/choose-template.css?v=2.0.3">
    ...
    <script src="https://www.topcv.vn/v2/js/jquery-1.11.2.min.js"></script>
</head>
<body>

<header id="header">
    <nav class="navbar navbar-default  no-sub-nav  ">
        <div class="container">
            <div class="navbar-header">
                <a href="/" class="navbar-brand">
                    <img src="https://yt3.ggpht.com/a-/AJLlDp33Jtm-wmda_ZVnmhT962ZCgPj9NED9enIUgQ=s900-mo-c-c0xffffffff-rj-k-no" style="max-width: 50px;">
                </a>
            </div>
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/">Trang chủ</a></li>
                    <li><a href="/about">Về S4C</a></li>
                    <li><a href="/choose-cv">Mẫu CV</a></li>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv1">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-pro_5.png" class="img-responsive">
                        </a>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv2">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-default.png" class="img-responsive">
                        </a>
                        <div class="cv-overlay">
                            <a href="javascript:showLoginPopup('', 'Đăng nhập hoặc Đăng ký để sử dụng mẫu CV!')">
                                <span>Dùng mẫu này</span>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv3">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-senior_2.png" class="img-responsive">
                        </a>
                        <div class="cv-overlay">
                            <a href="javascript:showLoginPopup('', 'Đăng nhập hoặc Đăng ký để sử dụng mẫu CV!')">
                                <span>Dùng mẫu này</span>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv4">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-modern_4.png" class="img-responsive">
                        </a>
                        <div class="cv-overlay">
                            <a href="javascript:showLoginPopup('', 'Đăng nhập hoặc Đăng ký để sử dụng mẫu CV!')">
                                <span>Dùng mẫu này</span>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv5">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-impressive_pro.png" class="img-responsive">
                        </a>
                        <div class="cv-overlay">
                            <a href="javascript:showLoginPopup('', 'Đăng nhập hoặc Đăng ký để sử dụng mẫu CV!')">
                                <span>Dùng mẫu này</span>
                ...
                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 template_cv">
                    <div class="cv-img">
                        <a href="/choose-cv/create-cv6">
                            <img src="https://www.topcv.vn/images/cv/screenshots/thumbs/vi/mau-cv-premium.png" class="img-responsive">
                        </a>
                        <div class="cv-overlay">
                            <a href="javascript:showLoginPopup('', 'Đăng nhập hoặc Đăng ký để sử dụng mẫu CV!')" >
                                <span>Dùng mẫu này</span>
...
<footer id="footer">
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-7">© 2018 S4C Club. All Rights Reserved</div>
                <div class="col-md-5 text-right">Địa chỉ: PTIT – Km10 Nguyễn Trãi, Hà Đông, Hà Nội</div>
            </div>
        </div>
    </div>
</footer>
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <form action="" id="form-login-ajax" autocomplete="off">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="password" class="form-control" name="password" autocomplete="off" placeholder="Mật khẩu" value="">
                                        </div>
                                        <div class="text-center btn-login-wraper">
                                            <button type="submit" class="btn btn-topcv-primary" id="btn-login-ajax">Đăng nhập</button>
                                        </div>
                                        <p class="text-center" style="font-size: 0.9em; margin-top: 5px; margin-bottom: 0;"><a target="_blank" href="https://www.topcv.vn/forgot-password">Quên mật khẩu?</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <form action="" id="form-signup-ajax" autocomplete="off">
                                    <div class="col-md-6 col-xs-12 text-center">
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" name="fullname" autocomplete="off" placeholder="Họ và tên" tabindex="1" value="">
                                        </div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                            <input type="password" class="form-control" name="password" autocomplete="off" placeholder="Mật khẩu" tabindex="3" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 text-center">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                            <input type="email" class="form-control" name="email" placeholder="Email" tabindex="2">
                                        </div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                            <input type="password" class="form-control" name="password_confirmation" placeholder="Nhập lại mật khẩu" tabindex="4">
                                        </div>
                                    </div>
                                    <p class="col-xs-12 agree-term text-center">
                                        <input type="checkbox" name="agree_term" checked>
                                        <span class="text-gray">Tôi đồng ý với <a target="_blank" href="https://www.topcv.vn/terms-of-service" class="text-highlight">Điều khoản dịch vụ</a> và <a target="_blank" href="https://www.topcv.vn/privacy-policy" class="text-highlight">Chính sách bảo mật</a> của S4C Club</span>
                                    </p>
                                    <div class="col-xs-12 text-center btn-login-wraper">
                                        <button type="submit" id="btn-signup-ajax" class="btn btn-topcv-primary">Đăng ký</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
fbq('init', '746984978746268');
fbq('track', 'PageView');
</script> -->
<!-- <noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=746984978746268&ev=PageView&noscript=1"
/></noscript> -->
</body>
</html>
